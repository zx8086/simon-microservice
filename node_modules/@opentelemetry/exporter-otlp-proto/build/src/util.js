...
function send(collector, objects, compression, onSuccess, onError) {
    ...
    if (message) {
        ...
        if (body) {
            exporter_otlp_http_1.sendWithHttp(collector, Buffer.from(body), 'application/x-protobuf', onSuccess, onError);
        }
    }
    else {
        onError(new exporter_otlp_http_1.otlpTypes.OTLPExporterError('No proto'));
    }
}
exports.send = send;
